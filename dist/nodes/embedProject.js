...
const embedProjectPlaceHolder_1 = __importDefault(require("../lib/embedProjectPlaceHolder"));
const Node_1 = __importDefault(require("./Node"));
const embedProject_1 = __importDefault(require("../rules/embedProject"));
const getLetter = (data) => {
    var _a, _b;
    return (((_b = (_a = data === null || data === void 0 ? void 0 : data.name) === null || _a === void 0 ? void 0 : _a.replace(/(?<first>\w{1})(?<dirty>.*)/, (...args) => {
...
class EmbedProject extends Node_1.default {
    ...
    get plugins() {
        return [embedProjectPlaceHolder_1.default, new prosemirror_state_1.Plugin({})];
    }
}
