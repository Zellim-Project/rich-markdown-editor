    ...
    constructor() {
        ...
        this.component = (props) => {
            ...
            return (React.createElement("div", { contentEditable: false, className: "embed-block mentioned-document", onClick: () => openDocument?.(docId) },
                React.createElement("div", { className: "mentioned-icon m-4 line-height-1" }, icon ? React.createElement("span", { className: "emoji" }, icon) : React.createElement(LinkedDoc, null)),
                React.createElement("div", { className: "mentioned-info me-4" },
                    React.createElement("p", { className: "doc-id" }, docId),
                    React.createElement("p", { className: `title fw-bold ${docId.includes("deleted") &&
                            "text-decoration-line-through"}` }, docName))));
        };
    }
    get name() {
