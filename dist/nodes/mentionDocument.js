...
export default class EmbedTask extends Node {
    constructor() {
        ...
        this.component = (props) => {
            ...
            return (React.createElement("div", { contentEditable: false, className: "embed-block", onClick: () => openDocument?.({ docId }) },
                React.createElement("div", { className: "mentioned-icon my-2 ms-2" }, icon ? React.createElement("span", { className: "me-3 emoji" }, icon) : React.createElement(Union, null)),
