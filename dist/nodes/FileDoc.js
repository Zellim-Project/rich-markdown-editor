...
const parseIcon_1 = require("../lib/parseIcon");
...
class File extends Node_1.default {
    constructor() {
        ...
        this.component = props => {
            ...
            return (React.createElement("div", { contentEditable: false, className: "embed-block", onClick: () => downloadAFile === null || downloadAFile === void 0 ? void 0 : downloadAFile(fileName) },
                React.createElement("div", { className: "file-icon" },
                    React.createElement("img", { src: `/assets/images/files${parseIcon_1.getIcon(alt, mimeType)}`, alt: "file-icon" })),
    ...
    parseMarkdown() {
        return {
            ...
            getAttrs: token => {
                ...
                const [fileName, size, type, mimeType] = (result === null || result === void 0 ? void 0 : result[2].split("&-&")) || [];
                return {
