...
class File extends Node_1.default {
    constructor() {
        ...
        this.component = props => {
            ...
            const dirPath = path_1.default.join(__dirname, "/src/lib/icons/files");
            return (React.createElement("div", { contentEditable: false, className: "embed-block" },
                React.createElement("div", { className: "file-icon" },
                    React.createElement("img", { src: `${dirPath}${parseIcon_1.getIcon(alt, mimeType)}`, alt: "file-icon" })),
    ...
    parseMarkdown() {
        return {
            ...
            getAttrs: token => {
                ...
                const [src, size, type, mimeType] = (result === null || result === void 0 ? void 0 : result[2].split("&-&")) || [];
                return {
                    src: result ? src : null,
