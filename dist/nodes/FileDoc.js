...
export default class File extends Node {
    constructor() {
        ...
        this.component = (props) => {
            ...
            return (React.createElement("div", { contentEditable: false, className: "embed-block", onClick: () => downloadAFile?.({ key, fileName }) },
                React.createElement("div", { className: "file-icon" },
                    React.createElement("img", { src: `/assets/images/files${getIcon(fileName, mimeType)}`, alt: "file-icon" })),
                React.createElement("div", { className: "info" },
                    React.createElement("span", { className: "mimetype" }, mimeType),
                    React.createElement("span", { className: "doc-key" }, key),
                    React.createElement("p", { className: "title" }, fileName),
