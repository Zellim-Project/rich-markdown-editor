...
class EmbedTask extends Node_1.default {
    constructor() {
        ...
        this.component = props => {
            ...
            return (React.createElement("div", { contentEditable: false, className: "task-block", onClick: () => openATask === null || openATask === void 0 ? void 0 : openATask(id) },
                React.createElement("div", { className: "icon" },
                    React.createElement(icons_1.Union, null)),
                React.createElement("div", { className: "info" },
                    React.createElement("p", { className: "task-id" }, id),
