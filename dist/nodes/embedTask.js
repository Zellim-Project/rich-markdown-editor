...
export default class EmbedTask extends Node {
    constructor() {
        ...
        this.component = (props) => {
            ...
            return (React.createElement("div", { contentEditable: false, className: "embed-block", onClick: () => openATask?.({ taskId, projectId }) },
                React.createElement("div", { className: "icon" },
                    React.createElement(Union, null)),
                React.createElement("div", { className: "info" },
                    React.createElement("p", { className: "task-id" }, taskId),
                    React.createElement("p", { className: "project-id" }, projectId),
                    React.createElement("p", { className: `title ${taskId === "deleted" &&
                            "text-decoration-line-through"}` }, taskName),
                    React.createElement("p", { className: `subtitle ${taskId === "deleted" &&
