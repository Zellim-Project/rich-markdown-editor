...
class CommandMenu extends React.Component {
    ...
    get filtered() {
        const { embeds = [], search = "", uploadImage, uploadFile, embedATask, commands, filterable = true, } = this.props;
    ...
    render() {
        const { dictionary, isActive, uploadImage, uploadFile, embedATask, } = this.props;
