...
const embedATask_1 = __importDefault(require("../commands/embedATask"));
const embedAProject_1 = __importDefault(require("../commands/embedAProject"));
...
class CommandMenu extends React.Component {
    constructor() {
        ...
        this.handleEmbedATask = event => {
            ...
            if (parent) {
                dispatch(state.tr.insertText("", parent.pos, parent.pos + parent.node.textContent.length + 1));
                embedATask_1.default(view, event, parent.pos, {
                    embedATask,
                    onShowToast,
                    dictionary: this.props.dictionary,
                });
        ...
        this.handleEmbedAProject = event => {
            ...
            if (parent) {
                dispatch(state.tr.insertText("", parent.pos, parent.pos + parent.node.textContent.length + 1));
                embedAProject_1.default(view, event, parent.pos, {
                    embedAProject,
                    onShowToast,
                    dictionary: this.props.dictionary,
                });
    ...
    get filtered() {
        const { embeds = [], search = "", uploadImage, uploadFile, embedATask, embedAProject, commands, filterable = true, } = this.props;
    ...
    render() {
        const { dictionary, isActive, uploadImage, uploadFile, embedATask, embedAProject, } = this.props;
        ...
        return (React.createElement(react_portal_1.Portal, null,
            React.createElement(exports.Wrapper, Object.assign({ id: this.props.id || "block-menu-container", active: isActive, ref: this.menuRef }, positioning),
                ...
                embedATask && (React.createElement(VisuallyHidden_1.default, null,
                    React.createElement("div", { ref: this.embedTaskRef, onClick: this.handleEmbedATask }))),
                embedAProject && (React.createElement(VisuallyHidden_1.default, null,
