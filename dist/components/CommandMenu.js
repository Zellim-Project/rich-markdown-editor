...
class CommandMenu extends React.Component {
    constructor() {
        ...
        this.handleFilePicked = (event) => {
            ...
            if (parent) {
                ...
                (0, insertAllFiles_1.default)(view, event, parent.pos, files, {
                    uploadFile,
                    onFileUploadStart,
                    onFileUploadStop,
                    onShowToast,
    ...
    render() {
        ...
        return (React.createElement(react_portal_1.Portal, null,
            React.createElement(exports.Wrapper, { id: this.props.id || "block-menu-container", active: isActive, ref: this.menuRef, ...positioning },
