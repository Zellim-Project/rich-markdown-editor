...
class LinkEditor extends React.Component {
    constructor() {
        ...
        this.handleCreateLink = async (value) => {
            this.discardInputValue = true;
            const { onCreateLink } = this.props;
            value = value.trim();
            if (value.length === 0) {
    ...
    render() {
        ...
        const isInternal = (0, urls_1.isInternalUrl)(value);
        ...
        return (React.createElement(Wrapper, null,
            ...
            React.createElement(Tooltip_1.default, { tooltip: dictionary.openLink },
                React.createElement(ToolbarButton_1.default, { onClick: this.handleOpenLink, disabled: !value }, isInternal ? (React.createElement(outline_icons_1.ArrowIcon, { color: "currentColor" })) : (React.createElement(outline_icons_1.OpenIcon, { color: "currentColor" })))),
            React.createElement(Tooltip_1.default, { tooltip: dictionary.removeLink },
                React.createElement(ToolbarButton_1.default, { onClick: this.handleRemoveLink }, this.initialValue ? (React.createElement(outline_icons_1.TrashIcon, { color: "currentColor" })) : (React.createElement(outline_icons_1.CloseIcon, { color: "currentColor" })))),
            showResults && (React.createElement(SearchResults, { id: "link-search-results" },
                results.map((result, index) => (React.createElement(LinkSearchResult_1.default, { key: result.url, title: result.title, subtitle: result.subtitle, icon: React.createElement(outline_icons_1.DocumentIcon, { color: "currentColor" }), onPointerMove: () => this.handleFocusLink(index), onClick: this.handleSelectLink(result.url, result.title), selected: index === selectedIndex }))),
                showCreateLink && (React.createElement(LinkSearchResult_1.default, { key: "create", title: suggestedLinkTitle, subtitle: dictionary.createNewDoc, icon: React.createElement(outline_icons_1.PlusIcon, { color: "currentColor" }), onPointerMove: () => this.handleFocusLink(results.length), onClick: () => {
