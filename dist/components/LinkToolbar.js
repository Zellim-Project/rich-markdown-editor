...
class LinkToolbar extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(FloatingToolbar_1.default, { ref: this.menuRef, active: active, ...rest }, active && (React.createElement(LinkEditor_1.default, { key: `${selection.from}-${selection.to}`, from: selection.from, to: selection.to, onCreateLink: onCreateLink ? this.handleOnCreateLink : undefined, onSelectLink: this.handleOnSelectLink, onRemoveLink: onClose, ...rest }))));
    }
}
