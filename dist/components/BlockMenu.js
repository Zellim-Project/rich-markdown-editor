...
class BlockMenu extends react_1.default.Component {
    ...
    render() {
        return (react_1.default.createElement(CommandMenu_1.default, { ...this.props, filterable: true, onClearSearch: this.clearSearch, renderMenuItem: (item, _index, options) => {
