...
class RichMarkdownEditor extends React.PureComponent {
    ...
    createState(value) {
        ...
        console.log(this.plugins, this.keymaps, prosemirror_dropcursor_1.dropCursor({ color: this.theme().cursor }), prosemirror_gapcursor_1.gapCursor(), prosemirror_inputrules_1.inputRules({
