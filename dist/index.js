...
class RichMarkdownEditor extends React.PureComponent {
    constructor() {
        ...
        this.dictionary = (0, memoize_1.default)((providedDictionary) => {
            return { ...dictionary_1.default, ...providedDictionary };
        });
    }
    componentDidMount() {
        this.init();
    ...
    createExtensions() {
        return new ExtensionManager_1.default(full_1.default, this);
    }
    createPlugins() {
    ...
    createState(value) {
        ...
        }, (0, prosemirror_dropcursor_1.dropCursor)({ color: this.props.theme?.cursor }), (0, prosemirror_gapcursor_1.gapCursor)(), (0, prosemirror_inputrules_1.inputRules)({
        ...
        return prosemirror_state_1.EditorState.create({
            ...
            plugins: [
                ...this.plugins,
                ...this.keymaps,
                (0, prosemirror_dropcursor_1.dropCursor)({ color: this.props.theme?.cursor }),
    ...
    createView() {
        ...
        const self = this;
        const view = new prosemirror_view_1.EditorView(this.element.current, {
            handleDOMEvents: {
    ...
    render() {
        const { dir, readOnly, readOnlyWriteCheckboxes, style, className, onKeyDown, } = this.props;
        ...
        return (React.createElement(Flex_1.default, { onKeyDown: onKeyDown, style: style, className: className, align: "flex-start", justify: "center", dir: dir, column: true },
            React.createElement(React.Fragment, null,
                React.createElement(editor_1.StyledEditor, { dir: dir, rtl: isRTL, readOnly: readOnly, readOnlyWriteCheckboxes: readOnlyWriteCheckboxes, ref: this.element }),
                !readOnly && this.view && (React.createElement(React.Fragment, null,
                    React.createElement(SelectionToolbar_1.default, { view: this.view, dictionary: dictionary, commands: this.commands, rtl: isRTL, isTemplate: this.props.template === true, onOpen: this.handleOpenSelectionMenu, onClose: this.handleCloseSelectionMenu, onSearchLink: this.props.onSearchLink, onClickLink: this.props.onClickLink, onCreateLink: this.props.onCreateLink, onShowToast: this.props.onShowToast }),
                    ...
                    React.createElement(BlockMenu_1.default, { view: this.view, commands: this.commands, dictionary: dictionary, rtl: isRTL, isActive: this.state.blockMenuOpen, search: this.state.blockMenuSearch, onClose: this.handleCloseBlockMenu, uploadImage: this.props.uploadFile, uploadFile: this.props.uploadFile, onLinkToolbarOpen: this.handleOpenLinkMenu, onImageUploadStart: this.props.onFileUploadStart, onImageUploadStop: this.props.onFileUploadStop, onFileUploadStart: this.props.onFileUploadStart, onFileUploadStop: this.props.onFileUploadStop, onShowToast: this.props.onShowToast, embeds: this.props.embeds }))))));
    }
}
