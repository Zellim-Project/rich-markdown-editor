...
exports.darkMobile = exports.lightMobile = exports.dark = exports.light = exports.base = void 0;
const polished_1 = require("polished");
const brackpoints_1 = __importDefault(require("./brackpoints"));
const colors = {
...
exports.base = {
    ...
    breakpoints: brackpoints_1.default,
};
exports.light = {
    ...exports.base,
    isDark: false,
    ...
    sidebarDraftBorder: (0, polished_1.darken)("0.25", colors.warmGrey),
    ...
    buttonNeutralBorder: (0, polished_1.darken)(0.15, colors.white),
    ...
    scrollbarThumb: (0, polished_1.darken)(0.15, colors.smokeDark),
};
exports.dark = {
    ...exports.base,
    isDark: true,
    ...
    textSecondary: (0, polished_1.lighten)(0.1, colors.slate),
    textTertiary: colors.slate,
    placeholder: colors.slateDark,
    sidebarBackground: colors.veryDarkBlue,
    sidebarActiveBackground: (0, polished_1.lighten)(0.02, colors.almostBlack),
    sidebarControlHoverBackground: colors.white10,
    sidebarDraftBorder: (0, polished_1.darken)("0.35", colors.slate),
    ...
    menuItemSelected: (0, polished_1.lighten)(0.1, "#1f2128"),
    menuBackground: "#1f2128",
    menuShadow: "0 0 0 1px rgba(0, 0, 0, 0.1), 0 8px 16px rgba(0, 0, 0, 0.3), 0 2px 4px rgba(0, 0, 0, 0.08)",
    divider: (0, polished_1.lighten)(0.1, colors.almostBlack),
    titleBarDivider: (0, polished_1.darken)(0.4, colors.slate),
    ...
    horizontalRule: (0, polished_1.lighten)(0.1, colors.almostBlack),
...
exports.lightMobile = exports.light;
exports.darkMobile = {
    ...exports.dark,
