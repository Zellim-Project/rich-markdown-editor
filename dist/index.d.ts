...
export declare type Props = {
    ...
    disableExtensions?: ("strong" | "code_inline" | "highlight" | "em" | "link" | "placeholder" | "strikethrough" | "underline" | "blockquote" | "bullet_list" | "checkbox_item" | "checkbox_list" | "code_block" | "code_fence" | "embed" | "br" | "heading" | "hr" | "container_image" | "list_item" | "container_notice" | "ordered_list" | "paragraph" | "table" | "td" | "th" | "tr" | "emoji" | "sync" | "container_project" | "container_task" | "container_file" | "history")[];
    autoFocus?: boolean;
    readOnly?: boolean;
...
declare class RichMarkdownEditor extends React.PureComponent<Props, State> {
    ...
    createDocument(content: string): Node | null;
    ...
    dictionary: ((providedDictionary?: Partial<{
        ...
        file: string;
        embedATask: string;
        embedAProject: string;
        linkDocument: string;
        linkADocument: string;
